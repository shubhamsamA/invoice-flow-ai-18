...
export const DEFAULT_CONTENT: Record<BuilderElementType, Record<string, any>> = {
  ...
  "items-table": { items: [{ name: "Item 1", qty: 1, price: 0, gst_type: "none", gst_rate: 0 }], columns: { description: "Description", qty: "Qty", price: "Price", gstType: "GST Type", gstRate: "GST%", gstAmt: "GST Amt", total: "Total" } },
